...
struct FormItemView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationStack{
            FormItemView(form: FormData(id: UUID(), time: 10, title: "title", type: "", companyID: "", companyName: "", description: "", backgroundImagePath: "", backgroundImageURL: "https://picsum.photos/200/300"))
                .frame(width: 250)
        }
    }
}
